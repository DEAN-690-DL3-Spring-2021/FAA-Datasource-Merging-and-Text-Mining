...
#Reading Dataset
sdr_data = read.csv('sdr_stm.csv',colClasses = c("NULL",NA,NA,NA,"NULL","NULL","NULL",NA))
str(sdr_data)

identifier_sdr <- read.csv('sdr_stm.csv',colClasses = c(NA,"NULL","NULL","NULL","NULL","NULL","NULL","NULL"))
str(identifier_sdr)
