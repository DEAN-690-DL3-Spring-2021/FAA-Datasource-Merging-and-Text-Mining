...
kResult <- searchK(out$documents, out$vocab, K=c(20:35), prevalence=~Aircraft_Type+Phase_Of_Flight+Month_Of_Occurrence,
...
prep<-estimateEffect(1:35~ Month_Of_Occurrence, stm_sdr_30, metadata=out$meta, uncertainty="Global")#nsim is defaulted to 25, but on a small model a higher number lead to more consistent results
